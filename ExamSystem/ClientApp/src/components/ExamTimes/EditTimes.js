...
const EditExamTime = () => {
    ...
    const loadExamTime = async () => {
        try {
            const response = await axiosPrivate.get(`/examtimes/${id}`);
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        ...
        await axiosPrivate.put(`/examtimes/${id}`, updatedExamData);
        handleGoBack();
      } catch (err) {
        console.error(err);
        navigate('/login', { state: { from: location }, replace: true });
            ...
            <div className="mb-3 row">
              ...
              <div className="col-sm-10">
                <input
                  ...
                  value={examData.date.substring(0,10)}
                  required
                />
              </div>
            </div>
            ...
            <div className="mb-3 row">
              ...
              <div className="col-sm-10">
                <input
                  ...
                  id="time"
                  onChange={handelInputChange}
                  value={examData.time.substring(11,16)}
                  required
                />
              </div>
            </div>
              ...
              <div className="col-sm-10">
                <div className="form-check">
                  <input
                    ...
                    id="status"
                    checked={examData.status === 1 ? true : false}
                  />
